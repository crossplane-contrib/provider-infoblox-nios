...
type SRVRecordInitParameters struct {
...
type SRVRecordSpec struct {
	...
	// autoscaler.
	InitProvider SRVRecordInitParameters `json:"initProvider,omitempty"`
}
...
// SRVRecord is the Schema for the SRVRecords API. <no value>
