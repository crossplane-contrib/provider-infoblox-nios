...
// GetInitParameters of this MX
func (tr *MX) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this MX
func (tr *MX) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
