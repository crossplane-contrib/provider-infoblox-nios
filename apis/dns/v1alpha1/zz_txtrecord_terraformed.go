...
func (tr *TXTRecord) GetObservation() (map[string]any, error) {
...
func (tr *TXTRecord) SetObservation(obs map[string]any) error {
...
func (tr *TXTRecord) GetParameters() (map[string]any, error) {
...
func (tr *TXTRecord) SetParameters(params map[string]any) error {
...
// GetInitParameters of this TXTRecord
func (tr *TXTRecord) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TXTRecord
func (tr *TXTRecord) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
