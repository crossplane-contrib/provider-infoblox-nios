...
// GetInitParameters of this CNAME
func (tr *CNAME) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CNAME
func (tr *CNAME) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
