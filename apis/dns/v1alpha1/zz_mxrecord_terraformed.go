...
func (tr *MXRecord) GetObservation() (map[string]any, error) {
...
func (tr *MXRecord) SetObservation(obs map[string]any) error {
...
func (tr *MXRecord) GetParameters() (map[string]any, error) {
...
func (tr *MXRecord) SetParameters(params map[string]any) error {
...
// GetInitParameters of this MXRecord
func (tr *MXRecord) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this MXRecord
func (tr *MXRecord) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
