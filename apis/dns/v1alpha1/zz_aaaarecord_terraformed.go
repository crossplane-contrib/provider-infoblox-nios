...
func (tr *AAAARecord) GetObservation() (map[string]any, error) {
...
func (tr *AAAARecord) SetObservation(obs map[string]any) error {
...
func (tr *AAAARecord) GetParameters() (map[string]any, error) {
...
func (tr *AAAARecord) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AAAARecord
func (tr *AAAARecord) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AAAARecord
func (tr *AAAARecord) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
