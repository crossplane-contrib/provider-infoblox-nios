...
func (tr *SRVRecord) GetObservation() (map[string]any, error) {
...
func (tr *SRVRecord) SetObservation(obs map[string]any) error {
...
func (tr *SRVRecord) GetParameters() (map[string]any, error) {
...
func (tr *SRVRecord) SetParameters(params map[string]any) error {
...
// GetInitParameters of this SRVRecord
func (tr *SRVRecord) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SRVRecord
func (tr *SRVRecord) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
