...
type TXTRecordInitParameters struct {
...
type TXTRecordSpec struct {
	...
	// autoscaler.
	InitProvider TXTRecordInitParameters `json:"initProvider,omitempty"`
}
...
// TXTRecord is the Schema for the TXTRecords API. <no value>
