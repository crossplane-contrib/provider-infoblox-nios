...
func (tr *ARecord) GetObservation() (map[string]any, error) {
...
func (tr *ARecord) SetObservation(obs map[string]any) error {
...
func (tr *ARecord) GetParameters() (map[string]any, error) {
...
func (tr *ARecord) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ARecord
func (tr *ARecord) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ARecord
func (tr *ARecord) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
