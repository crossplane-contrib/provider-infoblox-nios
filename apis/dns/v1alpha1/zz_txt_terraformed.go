...
// GetInitParameters of this TXT
func (tr *TXT) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TXT
func (tr *TXT) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
