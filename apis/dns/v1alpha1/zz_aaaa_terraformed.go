...
// GetInitParameters of this AAAA
func (tr *AAAA) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AAAA
func (tr *AAAA) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
