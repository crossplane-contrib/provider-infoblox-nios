...
// GetInitParameters of this SRV
func (tr *SRV) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SRV
func (tr *SRV) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
